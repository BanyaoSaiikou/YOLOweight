...
RGB_DIR = "/home/sciurus/sonohara_ws/image/RGB1"
if not os.path.exists(RGB_DIR):
    os.makedirs(RGB_DIR)
DEPTH_DIR = "/home/sciurus/sonohara_ws/image/DEPTH1"
...
class VideoRecorder:
    def __init__(self):
        ...
        self._video_name_rgb = '/home/sciurus/sonohara_ws/image/AVI/tuantd_rgb.avi'
...
#-------------------------------
        ...
        #cv2.waitKey(1)
#------------------------------------
        #desired_width = 640#2024/7/1
        #desired_height = 480#2024/7/1
        
        #resized_image = cv2.resize(input_image, (desired_width, desired_height))#2024/7/1
        #cv2.imwrite(os.path.join(RGB_DIR, str(self._frame_idx) + '.png'), resized_image)#2024/7/1
